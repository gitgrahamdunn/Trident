...
import { Hp as deriveSessionKey, Mi as resolveCommitHash, Up as resolveSessionKey, _g as ensureBinary, cf as installUnhandledRejectionHandler, gp as loadSessionStore, hv as loadDotEnv, nf as applyTemplate, t as getReplyFromConfig, u_ as loadConfig, uv as VERSION, vg as promptYesNo, vp as saveSessionStore } from "./reply-Bm8VrLQh.js";
...
import { r as normalizeEnv, t as isTruthyEnvValue } from "./env-CqXKEsUZ.js";
...
import { i as formatUncaughtError } from "./errors-C1t_6llh.js";
import { d as ensurePortAvailable, f as handlePortError, l as PortInUseError, u as describePortOwner } from "./cmd-argv-GXSSysSW.js";
import "./delivery-queue-B182HpX5.js";
import { l as resolveStorePath } from "./paths-DBVuZIGo.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-BZO9MGfW.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-KfI9f4T2.js";
import { n as resolveCliChannelOptions } from "./channel-options-P0-tsl0v.js";
...
const DEFAULT_TAGLINE = "All your agents, one Trident.";
...
const TAGLINES = [
	...
	"The only fork in your terminal you actually want to trust. 🔱",
	...
	"Built for operators, planners, and engineers. Keep shipping.",
	...
	"Half conductor, half debugger, full autonomy stack.",
	...
	"You had me at 'trident gateway start.'",
...
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-CJmA__Kb.js");
	return configGuardModulePromise;
}
function loadPluginRegistryModule() {
	pluginRegistryModulePromise ??= import("./plugin-registry-9WVGb5U7.js").then((n) => n.n);
...
if (isMainModule({ currentFile: fileURLToPath(import.meta.url) })) {
	...
	process$1.on("uncaughtException", (error) => {
		console.error("[trident] Uncaught exception:", formatUncaughtError(error));
		process$1.exit(1);
	});
	program.parseAsync(process$1.argv).catch((err) => {
		console.error("[trident] CLI failed:", formatUncaughtError(err));
		process$1.exit(1);
	});
}
//#endregion
