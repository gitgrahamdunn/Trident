import { A as getResolvedLoggerSettings, p as defaultRuntime } from "./subsystem-BDbeCphF.js";
...
import { An as formatRemainingShort, Cg as loadModelCatalog, Ch as readGatewayTokenEnv, Dt as randomToken, Ff as loadSessionStore, Gs as buildGatewayConnectionDetails, Hu as resolveBootstrapContextForRun, Iv as CLAUDE_CLI_PROFILE_ID, Km as resolveConfiguredSecretInputWithFallback, Ks as callGateway, Lv as CODEX_CLI_PROFILE_ID, M as resolveConfiguredModelRef, Mh as isLoopbackHost, N_ as resolveApiKeyForProvider, On as DEFAULT_OAUTH_WARN_MS, Op as formatSessionArchiveTimestamp, P as resolveHooksGmailModel, Pg as readConfigFileSnapshot, Rg as writeConfigFile, S as getModelRefStatus, Sv as DEFAULT_PROVIDER, Tt as printWizardHeader, Ur as analyzeBootstrapBudget, Wr as buildBootstrapInjectionStats, bn as resolveCronStorePath, cd as hasConfiguredMemorySecretInput, fg as DEFAULT_SANDBOX_IMAGE, g as updateAuthProfileStoreWithLock, hg as resolveBootstrapTotalMaxChars, i as resolveApiKeyForProfile, kf as resolveAgentSessionDirs, kn as buildAuthHealthSummary, kp as isPrimarySessionTranscriptFileName, l as repairOAuthProfileIdMismatch, ld as resolveMemorySearchConfig, mg as resolveBootstrapMaxChars, mt as applyWizardMetadata, nn as resolveDmAllowState, p as ensureAuthProfileStore, ph as hasAmbiguousGatewayAuthModeConfig, qp as cleanStaleLockFiles, r as resolveProfileUnusableUntilForDisplay, tg as resolveSandboxScope, ug as DEFAULT_SANDBOX_BROWSER_IMAGE, vh as resolveGatewayAuth, vp as resolveMainSessionKey, xn as saveCronStore, xv as DEFAULT_MODEL, yn as loadCronStore, yt as guardCancel, z as loadOpenClawPlugins, zh as resolveGatewayBindHost } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { _ as DEFAULT_AGENTS_FILENAME, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId } from "./agent-scope-CZIF93u7.js";
import { E as parseAgentSessionKey } from "./session-key-51LnISpq.js";
import { S as sleep, v as resolveUserPath, x as shortenHomePath } from "./utils-B88a096J.js";
...
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-BvNoSfUf.js";
import { r as resolveMemoryBackendConfig } from "./search-manager-CR5cykjp.js";
import { n as listChannelPlugins } from "./plugins-C-z6VZlO.js";
import { a as isWSLEnv, i as isWSL } from "./fetch-BmEnSimV.js";
import { m as formatPortDiagnostics, u as inspectPortUsage } from "./cmd-argv-Cnl266PT.js";
import { c as resolveSessionTranscriptsDirForAgent, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-B9q4Ev3T.js";
import { f as resolveGatewaySystemdServiceName, h as resolveNodeLaunchAgentLabel, l as resolveGatewayLaunchAgentLabel, p as resolveGatewayWindowsTaskName } from "./constants-CfAbrI_x.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-C94HXvSH.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-vZAAwjhY.js";
import { t as note$1 } from "./note-CU6pYH8p.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D0D1GN5e.js";
import { a as renderSystemNodeWarning, o as resolveSystemNodeInfo } from "./daemon-install-plan.shared-C827UpZv.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-BCj54YDR.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Cefje0FR.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-DnTV_bc7.js";
import { n as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-B6O2Y9L1.js";
import { i as isSystemdUserServiceAvailable, u as uninstallLegacySystemdUnits } from "./systemd---Z1c197.js";
import { c as buildPlatformRuntimeLogHints, i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as readEmbeddedGatewayToken, t as isSystemdUnavailableDetail, u as formatRuntimeStatus } from "./systemd-hints-C5pH3Xds.js";
import { n as readLastGatewayErrorLine } from "./diagnostics-BHRgvw1Q.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-C1wHV4Kt.js";
import { r as healthCommand } from "./health-DSTtGBUV.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-2PDMZv23.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-D_0axdYi.js";
import { f as normalizeStoredCronJobs, t as runGatewayUpdate } from "./update-runner-DwRB0HyE.js";
import { n as logConfigUpdated } from "./logging-DRp8gftI.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./oauth-tls-preflight-BgDtqYZW.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DM9Q7QuP.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CdgSjHC6.js";
import { t as formatHealthCheckFailure } from "./health-format-n3gqKELa.js";
import { n as doctorShellCompletion } from "./doctor-completion-LbNI8mVm.js";
...
async function maybeScanExtraGatewayServices(options, runtime, prompter) {
	...
	if (legacyServices.length > 0) {
		if (await prompter.confirmSkipInNonInteractive({
			...
			if (removed.length > 0) runtime.log("Legacy gateway services removed. Installing Trident gateway next.");
		}
	}
...
function noteStartupOptimizationHints(env = process.env, deps) {
	...
	const suggestions = [
		...
		"  export NODE_COMPILE_CACHE=/var/tmp/trident-compile-cache",
		"  mkdir -p /var/tmp/trident-compile-cache",
...
async function maybeRepairSandboxImages(cfg, runtime, prompter) {
	...
	if (!await isDockerAvailable()) {
		note$1([
			...
			"- Disable sandbox mode: trident config set agents.defaults.sandbox.mode off"
		].join("\n"), "Sandbox");
		return cfg;
	}
	let next = cfg;
...
async function noteStateIntegrity(cfg, prompter, configPath) {
	...
	if (cloudSyncedStateDir) warnings.push([
		...
		`  Set locally: OPENCLAW_STATE_DIR=~/.trident ${formatCliCommand("trident doctor")}`
	].join("\n"));
	...
	if (entries.length > 0) {
		...
		if (missing.length > 0) warnings.push([
			...
			`  Verify sessions in store: ${formatCliCommand(`trident sessions --store "${absoluteStorePath}"`)}`,
			`  Preview cleanup impact: ${formatCliCommand(`trident sessions cleanup --store "${absoluteStorePath}" --dry-run`)}`,
			`  Prune missing entries: ${formatCliCommand(`trident sessions cleanup --store "${absoluteStorePath}" --enforce --fix-missing`)}`
		].join("\n"));
...
async function maybeOfferUpdateBeforeDoctor(params) {
	...
	if (git === "git") {
		if (!await params.confirm({
			message: "Update Trident from git before running doctor?",
			initialValue: true
