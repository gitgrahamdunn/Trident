...
import { b as shortenHomeInString, v as resolveUserPath, x as shortenHomePath } from "./utils-B88a096J.js";
...
import { O as applyExclusiveSlotSelection, k as defaultSlotIdForKey } from "./registry-DtTKJfN8.js";
import { m as clearPluginManifestRegistryCache, y as resolvePluginSourceRoots } from "./skills-CtzUimzY.js";
...
import { n as setPluginEnabledInConfig, t as enablePluginInConfig } from "./enable-C_k_lH3p.js";
import { u as resolveArchiveKind } from "./install-safe-path-DZM2JHcC.js";
import "./npm-pack-install-BaqI_j6p.js";
import "./skill-scanner-Ms0uZYdw.js";
import { c as installPluginFromPath, l as resolvePluginInstallDir, n as recordPluginInstall, r as findBundledPluginSource, s as installPluginFromNpmSpec } from "./installs-K3NXKFo2.js";
import { r as resolveBundledInstallPlanForNpmFailure, t as resolveBundledInstallPlanBeforeNpm } from "./plugin-install-plan-KM-lV5Yn.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-BF1XI13C.js";
import { i as buildPluginStatusReport, n as resolvePinnedNpmInstallRecordForCli, r as looksLikeLocalInstallSpec } from "./npm-resolution-bIFZXmy_.js";
import { n as updateNpmInstalledPlugins } from "./update-9MUEa2z_.js";
...
function registerPluginsCli(program) {
	const plugins = program.command("plugins").description("Manage Trident plugins and extensions").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/plugins", "github.com/gitgrahamdunn/trident-cli/tree/main/docs/cli/plugins")}\n`);
