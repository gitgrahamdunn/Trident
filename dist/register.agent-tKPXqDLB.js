...
import { p as defaultRuntime, w as setVerbose } from "./subsystem-D2xHvZZd.js";
import { r as theme } from "./theme-CipOb_We.js";
import { S as shortenHomePath, y as resolveUserPath } from "./utils-DwZbjiC4.js";
import { Cm as GATEWAY_CLIENT_MODES, Cn as parseIdentityMarkdown, Ds as callGateway, G as withProgress, __ as writeConfigFile, bt as ensureWorkspaceAndSessions, bv as ensureAuthProfileStore, ks as randomIdempotencyKey, q as formatHelpExamples, u_ as loadConfig, wm as GATEWAY_CLIENT_NAMES, wt as moveToTrash, wv as resolveAuthStorePath, xn as identityHasValues, ym as normalizeMessageChannel } from "./reply-Bm8VrLQh.js";
import { a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, n as listAgentEntries, r as listAgentIds } from "./agent-scope-DvYJ0Ktc.js";
import { c as normalizeAgentId, g as DEFAULT_ACCOUNT_ID, t as DEFAULT_AGENT_ID } from "./session-key-BFl8Ucce.js";
import "./trident-root-3m-COvjr.js";
...
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin, ut as resolveChannelDefaultAccountId, x as listRouteBindings, y as isRouteBinding } from "./plugins-Csb211Yn.js";
...
import { c as resolveSessionTranscriptsDirForAgent } from "./paths-DBVuZIGo.js";
...
import { t as createDefaultDeps } from "./deps-C7FLTx5O.js";
import { t as collectOption } from "./helpers-DjgA-EwS.js";
...
import { t as createClackPrompter } from "./clack-prompter-CM0UnOGZ.js";
import { a as parseBindingSpecs, i as describeBinding, n as applyAgentBindings, o as removeAgentBindings, r as buildChannelBindings, t as requireValidConfigSnapshot } from "./config-validation-B4b0uzNS.js";
import { a as pruneAgentConfig, i as loadAgentIdentity, n as buildAgentSummaries, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-sYBKtrn0.js";
...
import { r as setupChannels } from "./onboard-channels-BaiiMXcA.js";
import "./auth-choice.apply-helpers-CXpFCGqS.js";
import "./issue-format-D_xZiVge.js";
import { r as resolveSessionKeyForRequest, t as agentCommand } from "./agent-DAe9ZbJa.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-DWKyP81v.js";
import { n as warnIfModelConfigLooksOff, r as applyAuthChoice } from "./auth-choice-D90EZ4gH.js";
...
async function agentViaGatewayCommand(opts, runtime) {
	...
	if (agentId) {
		if (!listAgentIds(cfg).includes(agentId)) throw new Error(`Unknown agent id "${agentIdRaw}". Use "${formatCliCommand("trident agents list")}" to see configured agents.`);
	}
...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	try {
		await prompter.intro("Add Trident agent");
		...
		} else await prompter.note(["Routing unchanged. Add bindings when you're ready.", "Docs: https://docs.trident.ai/concepts/multi-agent"].join("\n"), "Routing");
...
${formatHelpExamples([
		["trident agent --to +15555550123 --message \"status update\"", "Start a new session."],
		["trident agent --agent ops --message \"Summarize logs\"", "Use a specific agent."],
		["trident agent --session-id 1234 --message \"Summarize inbox\" --thinking medium", "Target a session with explicit thinking level."],
		["trident agent --to +15555550123 --message \"Trace logs\" --verbose on --json", "Enable verbose logging and JSON output."],
		["trident agent --to +15555550123 --message \"Summon reply\" --deliver", "Deliver reply."],
		["trident agent --agent ops --message \"Generate report\" --deliver --reply-channel slack --reply-to \"#reports\"", "Send reply to a different channel/target."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.trident.ai/cli/agent")}`).action(async (opts) => {
...
${theme.heading("Examples:")}
${formatHelpExamples([
		["trident agents set-identity --agent main --name \"Trident\" --emoji \"🔱\"", "Set name + emoji."],
		["trident agents set-identity --agent main --avatar avatars/trident.png", "Set avatar path."],
		["trident agents set-identity --workspace ~/.trident/workspace --from-identity", "Load from IDENTITY.md."],
		["trident agents set-identity --identity-file ~/.trident/workspace/IDENTITY.md --agent main", "Use a specific IDENTITY.md."]
	])}
`).action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
