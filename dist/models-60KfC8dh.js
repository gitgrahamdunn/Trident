...
import { n as isRich$1, r as theme, t as colorize } from "./theme-H80Q3Qtv.js";
...
import { i as coerceSecretRef, l as normalizeSecretInputString } from "./types.secrets-BvNoSfUf.js";
...
import { i as parseDurationMs } from "./search-manager-CR5cykjp.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-B9q4Ev3T.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-u6XwL9IS.js");
	const { ensureOpenClawModelsJson } = await import("./auth-profiles-DRjqKE3G.js").then((n) => n.wg);
