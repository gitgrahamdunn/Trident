import { A as getResolvedLoggerSettings, p as defaultRuntime, v as danger, w as setVerbose } from "./subsystem-BDbeCphF.js";
import "./paths-dQ_clcF4.js";
import { r as theme } from "./theme-H80Q3Qtv.js";
import "./boolean-DTgd5CzD.js";
import { Fa as parseDiscordTarget, G as formatHelpExamples, Ks as callGateway, Li as loadProviderUsageSummary, Pg as readConfigFileSnapshot, Rg as writeConfigFile, Ri as formatUsageReportLines, U as withProgress, Ud as createSlackWebClient, Z as resolveCommandSecretRefsViaGateway, Zi as formatTimeAgo, ao as resolveMessageChannelSelection, et as deleteTelegramUpdateOffset, hr as hasResolvedCredentialValue, jg as loadConfig, m as loadAuthProfileStore, mr as hasConfiguredUnavailableCredentialStatus, q as getChannelsCommandSecretTargetIds, to as listChannelPluginCatalogEntries, zn as fetchChannelPermissionsDiscord } from "./auth-profiles-DRjqKE3G.js";
...
import { _ as normalizeAccountId } from "./session-key-51LnISpq.js";
import { u as isRecord } from "./utils-B88a096J.js";
...
import { lt as parseOptionalDelimitedEntries, n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin, u as resolveTelegramAccount, ut as resolveChannelDefaultAccountId } from "./plugins-C-z6VZlO.js";
...
import { n as moveSingleAccountChannelSectionToDefaultAccount } from "./api-CVGd6c_4.js";
import "./note-CU6pYH8p.js";
import { t as createClackPrompter } from "./clack-prompter-mTn-BL6m.js";
import { i as describeBinding, n as applyAgentBindings, t as requireValidConfigSnapshot } from "./config-validation-BeRTvuND.js";
import { n as buildAgentSummaries } from "./agents.config-DfeGsm62.js";
...
import { a as reloadOnboardingPluginRegistry, i as ensureOnboardingPluginInstalled, r as setupChannels } from "./onboard-channels-CZyPCHEd.js";
import "./auth-choice.apply-helpers-Bcqf2um4.js";
import "./issue-format-DSEqPkwx.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-H_1uYq8w.js";
...
import "./plugin-registry-B0_Af19D.js";
import { t as formatCliChannelOptions } from "./channel-options-CAEyWh-A.js";
...
function formatGatewayChannelsStatusLines(payload) {
	...
	if (issues.length > 0) {
		...
		lines.push(`- Run: ${formatCliCommand("trident doctor")}`);
		lines.push("");
	}
...
function registerChannelsCli(program) {
	...
	const channels = program.command("channels").description("Manage connected chat channels and accounts").addHelpText("after", () => `\n${theme.heading("Examples:")}\n${formatHelpExamples([
		["trident channels list", "List configured channels and auth profiles."],
		["trident channels status --probe", "Run channel status checks and probes."],
		["trident channels add --channel telegram --token <token>", "Add or update a channel account non-interactively."],
		["trident channels login --channel whatsapp", "Link a WhatsApp Web account."]
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/channels", "docs.trident.ai/cli/channels")}\n`);
