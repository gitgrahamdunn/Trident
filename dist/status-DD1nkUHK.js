...
import { y as info } from "./subsystem-BDbeCphF.js";
import { u as resolveGatewayPort } from "./paths-dQ_clcF4.js";
import { n as isRich, r as theme } from "./theme-H80Q3Qtv.js";
import { $i as resolveContextTokensForModel, Do as summarizeRestartSentinel, Eo as readRestartSentinel, Ff as loadSessionStore, Ft as normalizeControlUiBasePath, Gs as buildGatewayConnectionDetails, Hi as classifySessionKey, Ks as callGateway, Li as loadProviderUsageSummary, M as resolveConfiguredModelRef, Ng as readBestEffortConfig, Ot as resolveControlUiLinks, Pg as readConfigFileSnapshot, Qh as readTailscaleStatusJson, Ri as formatUsageReportLines, Sv as DEFAULT_PROVIDER, U as withProgress, Ui as listAgentsForGateway, Vn as getRemoteSkillEligibility, X as getStatusCommandSecretTargetIds, Yi as resolveSessionModelRef, Z as resolveCommandSecretRefsViaGateway, Zh as getTailnetHostname, Zi as formatTimeAgo, cr as buildChannelSummary, dr as formatChannelAllowFrom, fr as resolveChannelAccountConfigured, hr as hasResolvedCredentialValue, jg as loadConfig, ks as formatDurationPrecise, lr as inspectReadOnlyChannelAccount, mr as hasConfiguredUnavailableCredentialStatus, pp as resolveFreshSessionTotalTokens, pr as resolveChannelAccountEnabled, su as peekSystemEvents, uo as sha256HexPrefix, ur as buildChannelAccountSnapshot, vp as resolveMainSessionKey, xv as DEFAULT_MODEL } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { d as resolveAgentWorkspaceDir } from "./agent-scope-CZIF93u7.js";
import { E as parseAgentSessionKey } from "./session-key-51LnISpq.js";
import { n as runExec } from "./exec-CdZJtviz.js";
...
import { t as getMemorySearchManager } from "./search-manager-CR5cykjp.js";
...
import { t as formatConfigIssueLine } from "./issue-format-DSEqPkwx.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D0D1GN5e.js";
import { c as resolveGatewayLogPaths } from "./launchd-DnTV_bc7.js";
import { n as resolveGatewayService } from "./service-B6O2Y9L1.js";
import { t as formatRuntimeStatusWithDetails } from "./runtime-status-C_uvG2so.js";
...
import { o as resolveHeartbeatSummaryForAgent, t as formatHealthChannelLines } from "./health-DSTtGBUV.js";
import { a as formatGitInstallLabel, g as resolveUpdateChannelDisplay, m as normalizeUpdateChannel, n as checkUpdateStatus, t as resolveDefaultChannelAccountContext } from "./channel-account-context-D_0axdYi.js";
import { t as runSecurityAudit } from "./audit-B7jSQKAT.js";
import { t as resolveNodeService } from "./node-service-7yIc6RRY.js";
import { n as redactSecrets, t as formatGatewayAuthUsed } from "./format-Dq7PmCR1.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-BDMAkJyU.js";
import { t as shortenText } from "./text-format-B5dc6Kwr.js";
...
async function appendStatusAllDiagnosis(params) {
	...
	lines.push("Troubleshooting: https://docs.trident.ai/troubleshooting");
	lines.push("");
}
//#endregion
...
async function buildStatusAllReportLines(params) {
	...
	const lines = [];
	lines.push(heading("Trident status --all"));
	lines.push("");
	...
	await withProgress({
		...
		const lines = await buildStatusAllReportLines({
			...
			overviewRows: [
				...
				{
					Item: "Security",
					Value: `Run: ${formatCliCommand("trident security audit --deep")}`
				},
				gatewaySelfLine ? {
					Item: "Gateway self",
...
async function statusCommand(opts, runtime) {
	...
	runtime.log(theme.heading("Trident status"));
	runtime.log("");
	...
	if (pairingRecovery) {
		...
		runtime.log(theme.muted(`Fallback: ${formatCliCommand("trident devices approve --latest")}`));
		runtime.log(theme.muted(`Inspect: ${formatCliCommand("trident devices list")}`));
	}
	runtime.log("");
	...
	runtime.log(theme.muted(`Full report: ${formatCliCommand("trident security audit")}`));
	runtime.log(theme.muted(`Deep probe: ${formatCliCommand("trident security audit --deep")}`));
	runtime.log("");
	...
	runtime.log("");
	runtime.log("FAQ: https://docs.trident.ai/faq");
	runtime.log("Troubleshooting: https://docs.trident.ai/troubleshooting");
	runtime.log("");
	...
	runtime.log(`  Need to share?      ${formatCliCommand("trident status --all")}`);
	runtime.log(`  Need to debug live? ${formatCliCommand("trident logs --follow")}`);
	if (gatewayReachable) runtime.log(`  Need to test channels? ${formatCliCommand("trident status --deep")}`);
	else runtime.log(`  Fix reachability first: ${formatCliCommand("trident gateway probe")}`);
}
//#endregion
