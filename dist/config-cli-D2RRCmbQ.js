import { E as success, p as defaultRuntime, v as danger, y as info } from "./subsystem-BDbeCphF.js";
import { t as CONFIG_PATH } from "./paths-dQ_clcF4.js";
import { r as theme } from "./theme-H80Q3Qtv.js";
import "./boolean-DTgd5CzD.js";
import { Pg as readConfigFileSnapshot, Rg as writeConfigFile } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import "./agent-scope-CZIF93u7.js";
import { y as isBlockedObjectKey } from "./session-key-51LnISpq.js";
...
import { n as formatConfigIssueLines, r as normalizeConfigIssues } from "./issue-format-DSEqPkwx.js";
import { t as redactConfigObject } from "./redact-snapshot-3SwEUYfq.js";
...
function formatDoctorHint(message) {
	return `Run \`${formatCliCommand("trident doctor")}\` ${message}`;
}
...
async function runConfigValidate(opts = {}) {
	const runtime = opts.runtime ?? defaultRuntime;
	let outputPath = CONFIG_PATH ?? "trident.json";
	try {
		const snapshot = await readConfigFileSnapshot();
