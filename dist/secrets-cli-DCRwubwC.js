...
import { $m as isNonEmptyString, Ag as createConfigIO, Cs as isExpectedResolvedSecretValue, Es as setPathCreateStrict, Jm as isProviderScopedSecretResolutionError, O as normalizeProviderId, Qm as describeUnknownError, Ss as hasConfiguredPlaintextSecretValue, Ts as getPath, Vg as SecretProviderSchema, Xm as resolveSecretRefValue, Zm as resolveSecretRefValues, _ as resolveAuthStorePath, __ as isSafeExecutableValue, bs as resolvePlanTargetAgainstRegistry, ds as prepareSecretsRuntimeSnapshot, dv as isNonSecretApiKeyMarker, eh as isRecord, fv as isSecretRefHeaderValueMarker, gs as discoverConfigSecretTargets, h as loadAuthProfileStoreForSecretsRuntime, hs as discoverAuthProfileSecretTargets, ih as writeTextFileAtomic, nh as parseEnvValue, rh as toDotPath, th as parseDotPath, vs as isKnownSecretTargetType, ws as deletePathStrict, xs as assertExpectedResolvedSecretValue, ys as listAuthProfileSecretTargetEntries } from "./auth-profiles-DRjqKE3G.js";
import { a as resolveAgentDir, f as resolveDefaultAgentId, i as resolveAgentConfig, r as listAgentIds } from "./agent-scope-CZIF93u7.js";
import { c as normalizeAgentId } from "./session-key-51LnISpq.js";
import { h as resolveConfigDir, v as resolveUserPath } from "./utils-B88a096J.js";
import "./boundary-file-read-Bb0WDUIN.js";
import "./logger-D0msxOz2.js";
import "./exec-CdZJtviz.js";
import { d as resolveSecretInputRef, i as coerceSecretRef } from "./types.secrets-BvNoSfUf.js";
...
import { At as isValidSecretProviderAlias, Dt as formatExecSecretRefIdValidationMessage, Mt as secretRefKey, Ot as isValidExecSecretRefId, jt as resolveDefaultSecretProviderAlias } from "./plugins-C-z6VZlO.js";
import { U as runTasksWithConcurrency } from "./query-expansion-E78fX0en.js";
...
import { r as listKnownSecretEnvVarNames, t as PROVIDER_ENV_VARS } from "./provider-env-vars-eiXtKwfg.js";
		...
		while (true) {
			...
			const options = visibleCandidates.map((candidate) => ({
				...
				label: candidate.label,
					hint: [candidate.configFile === "auth-profiles.json" ? "auth-profiles.json" : "trident.json", candidate.isDerived === true ? "derived" : void 0].filter(Boolean).join(" | ")
			}));
			options.push({
