...
import { $h as promptYesNo, Rg as writeConfigFile, jg as loadConfig } from "./auth-profiles-DRjqKE3G.js";
...
import { t as CONFIG_DIR, v as resolveUserPath, x as shortenHomePath } from "./utils-B88a096J.js";
...
import { _ as validateRegistryNpmSpec } from "./env-overrides-D7R3RscC.js";
import "./version-DcA9ITyc.js";
import { n as isPathInside, r as isPathInsideWithRealpath } from "./scan-paths-BubMcdO4.js";
...
import { a as unscopedPackageName, c as fileExists, l as readJsonFile, n as resolveSafeInstallDir, u as resolveArchiveKind } from "./install-safe-path-DZM2JHcC.js";
import { a as installPackageDir, c as resolveTimedInstallModeOptions, f as resolveArchiveSourcePath, i as resolveCanonicalInstallTarget, l as resolveExistingInstallPath, n as installFromNpmSpecArchiveWithInstaller, o as installPackageDirWithManifestDeps, r as ensureInstallTargetAvailable, s as resolveInstallModeOptions, t as finalizeNpmSpecArchiveInstall, u as withExtractedArchiveRoot } from "./npm-pack-install-BaqI_j6p.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-BF1XI13C.js";
import { a as parseFrontmatter, t as loadWorkspaceHookEntries } from "./workspace-BlDHIQ9V.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-BPhf4-Pn.js";
import { i as buildPluginStatusReport, n as resolvePinnedNpmInstallRecordForCli, r as looksLikeLocalInstallSpec, t as buildNpmInstallRecordFields } from "./npm-resolution-bIFZXmy_.js";
...
function formatHooksList(report, opts) {
	...
	if (hooks.length === 0) return opts.eligible ? `No eligible hooks found. Run \`${formatCliCommand("trident hooks list")}\` to see all hooks.` : "No hooks found.";
...
function formatHookInfo(report, hookName, opts) {
	...
	if (!hook) {
		...
		return `Hook "${hookName}" not found. Run \`${formatCliCommand("trident hooks list")}\` to see available hooks.`;
	}
