...
import { At as randomToken, Ft as waitForGatewayReachable, G as withProgress, Nt as summarizeExistingConfig, Ot as printWizardHeader, Pt as validateGatewayPasswordInput, St as guardCancel, Tt as normalizeGatewayTokenInput, __ as writeConfigFile, _t as applyWizardMetadata, bt as ensureWorkspaceAndSessions, bv as ensureAuthProfileStore, gt as DEFAULT_WORKSPACE, jt as resolveControlUiLinks, kt as probeGatewayReachable, mg as findTailscaleBinary, p_ as readConfigFileSnapshot, u_ as loadConfig } from "./reply-Bm8VrLQh.js";
import { f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir } from "./agent-scope-DvYJ0Ktc.js";
...
import { jt as resolveDefaultSecretProviderAlias, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-Csb211Yn.js";
...
import { r as setupChannels, t as noteChannelStatus } from "./onboard-channels-BaiiMXcA.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd-ClrEDLHE.js";
...
import { r as applyAuthChoice } from "./auth-choice-D90EZ4gH.js";
import { t as resolvePreferredProviderForAuthChoice } from "./auth-choice.preferred-provider-C5uRiZEh.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-DKb9YwGL.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DBh5jHFx.js";
import { a as promptCustomApiConfig } from "./onboard-custom-BGoQ64_M.js";
...
import { n as promptRemoteGatewayConfig } from "./onboard-remote-CtkjbNZt.js";
import { n as setupSkills } from "./onboard-skills-BuMI04IG.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-DRWsG1VN.js");
