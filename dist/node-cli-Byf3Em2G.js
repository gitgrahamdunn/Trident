...
import { r as theme, t as colorize } from "./theme-H80Q3Qtv.js";
import "./boolean-DTgd5CzD.js";
import { $l as loadOrCreateDeviceIdentity, Au as requestJsonlSocket, Bt as resolveGatewayConnectionAuth, Bu as resolveAllowAlwaysPatterns, Du as resolveExecApprovals, Eu as requiresExecApproval, G as formatHelpExamples, Hp as GATEWAY_CLIENT_NAMES, Is as formatExecCommand, Iu as resolveExecSafeBinRuntimePolicy, Ls as resolveSystemRunCommandRequest, Pu as isInterpreterLikeSafeBin, Ru as evaluateExecAllowlist, Tu as recordAllowlistUse, Vp as GATEWAY_CLIENT_MODES, Vs as normalizeSystemRunApprovalPlan, Xr as withTimeout, Zp as writeJsonAtomic, a_ as resolvePlannedSegmentArgv, c_ as POSIX_SHELL_WRAPPERS, d_ as unwrapKnownShellMultiplexerInvocation, f_ as POSIX_INLINE_COMMAND_FLAGS, fm as createBrowserRouteDispatcher, gu as ensureExecApprovals, hu as addAllowlistEntry, i_ as analyzeArgvCommand, ic as GatewayClient, jg as loadConfig, ku as saveExecApprovals, l_ as normalizeExecutableToken, mm as startBrowserControlServiceFromConfig, o_ as resolveCommandResolutionFromArgv, p_ as resolveInlineCommandMatch, pm as createBrowserControlContext, s_ as resolveExecutableFromPathEnv, u_ as unwrapKnownDispatchWrapperInvocation, ud as getMachineDisplayName, wu as readExecApprovalsSnapshot, xm as resolveBrowserConfig, xu as normalizeExecApprovals, yu as mergeExecApprovalsSocketDefaults, zu as evaluateShellAllowlist } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { i as resolveAgentConfig } from "./agent-scope-CZIF93u7.js";
import "./utils-B88a096J.js";
import { a as sameFileIdentity } from "./boundary-file-read-Bb0WDUIN.js";
import { i as logWarn } from "./logger-D0msxOz2.js";
...
import { S as sanitizeSystemRunEnvOverrides, x as sanitizeHostExecEnv } from "./env-overrides-D7R3RscC.js";
import { t as VERSION } from "./version-DcA9ITyc.js";
import { a as splitShellArgs } from "./search-manager-CR5cykjp.js";
import "./plugins-C-z6VZlO.js";
import { W as detectMime } from "./query-expansion-E78fX0en.js";
...
import { _ as resolveNodeWindowsTaskName, c as formatNodeServiceDescription, g as resolveNodeSystemdServiceName, h as resolveNodeLaunchAgentLabel } from "./constants-CfAbrI_x.js";
...
import { l as buildNodeServiceEnvironment, n as resolveDaemonInstallRuntimeInputs, p as resolveNodeProgramArguments, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-C827UpZv.js";
import "./runtime-guard-BGuMyQeT.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-Cefje0FR.js";
import "./runtime-parse-BCRWcre9.js";
import "./launchd-DnTV_bc7.js";
import "./service-B6O2Y9L1.js";
import "./systemd---Z1c197.js";
import { _ as installDaemonServiceAndEmit, a as createCliStatusTextStyles, g as buildDaemonServiceSnapshot, i as runServiceUninstall, m as resolveRuntimeStatusColor, o as createDaemonInstallActionContext, r as runServiceStop, s as failIfNixDaemonInstallMode, t as runServiceRestart } from "./lifecycle-core-BWGEd8ra.js";
import { c as buildPlatformRuntimeLogHints, l as buildPlatformServiceStartHints, u as formatRuntimeStatus } from "./systemd-hints-C5pH3Xds.js";
import { t as parsePort } from "./parse-port-D6GsOzX2.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS, t as NODE_BROWSER_PROXY_COMMAND } from "./node-commands--AoYOs2B.js";
...
function renderNodeServiceStartHints() {
	return buildPlatformServiceStartHints({
		installCommand: formatCliCommand("trident node install"),
		startCommand: formatCliCommand("trident node start"),
...
async function runNodeDaemonInstall(opts) {
	...
	if (loaded && !opts.force) {
		...
		if (!json) {
			...
			defaultRuntime.log(`Reinstall with: ${formatCliCommand("trident node install --force")}`);
		}
		return;
	}
...
function registerNodeCli(program) {
	...
	])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/node", "docs.trident.ai/cli/node")}\n`);
