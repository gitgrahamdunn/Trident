import { nt as isNodeRuntime, tt as isBunRuntime } from "./subsystem-BDbeCphF.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { d as getMinimalServicePathPartsFromEnv, i as isVersionManagedNodePath, r as isSystemNodePath, s as resolveSystemNodePath } from "./daemon-install-plan.shared-C827UpZv.js";
import { a as toPosixPath } from "./runtime-parse-BCRWcre9.js";
import { c as resolveGatewayLogPaths, l as resolveLaunchAgentPlistPath } from "./launchd-DnTV_bc7.js";
import { s as resolveSystemdUserUnitPath } from "./systemd---Z1c197.js";
...
function auditGatewayToken(command, issues, expectedGatewayToken) {
	...
	issues.push({
		...
		message: "Gateway service embeds TRIDENT_GATEWAY_TOKEN and should be reinstalled.",
	...
	issues.push({
		...
		message: "Gateway service token does not match gateway.auth.token in trident.json",
