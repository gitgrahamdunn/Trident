import { c as resolveStateDir, f as resolveRequiredHomeDir, l as expandHomePrefix } from "./paths-CzCvxHkV.js";
import { B as shouldLogVerbose, I as danger, J as resolveNodeRequireFromMeta, O as createSubsystemLogger, g as pathExists$1, i as logWarn, n as logError, t as logDebug, y as resolveUserPath } from "./logger-Cmh2bFJD.js";
...
function resolveDefaultAgentWorkspaceDir(env = process.env, homedir = os.homedir) {
	...
	const profile = env.TRIDENT_PROFILE?.trim() || env.OPENCLAW_PROFILE?.trim();
	if (profile && profile.toLowerCase() !== "default") return path.join(home, ".trident", `workspace-${profile}`);
	return path.join(home, ".trident", "workspace");
}
...
const WORKSPACE_STATE_DIRNAME = ".trident";
...
//#endregion
export { appendFileWithinRoot as $, normalizeWindowsPathForComparison as $t, supportsMemoryMultimodalEmbeddings as A, resolveAgentModelFallbackValues as An, DEFAULT_BOOTSTRAP_FILENAME as At, resolveWindowsSpawnProgram as B, resolveOpenClawPackageRootSync as Bt, isFileMissingError as C, deriveSessionChatType as Cn, resolveDefaultAgentId as Ct, getMemoryMultimodalExtensions as D, isSubagentSessionKey as Dn, resolveSessionAgentIds as Dt, classifyMemoryMultimodalPath as E, isCronSessionKey as En, resolveSessionAgentId as Et, resolveSessionTranscriptPath as F, DEFAULT_USER_FILENAME as Ft, isAudioFileName as G, markOpenClawExecEnv as Gt, extensionForMime as H, runExec as Ht, resolveSessionTranscriptPathInDir as I, ensureAgentWorkspace as It, normalizeMimeType as J, openBoundaryFileSync as Jt, isGifMedia as K, canUseBoundaryFileOpen as Kt, resolveSessionTranscriptsDirForAgent as L, filterBootstrapFilesForSession as Lt, resolveDefaultSessionStorePath as M, toAgentModelListLike as Mn, DEFAULT_IDENTITY_FILENAME as Mt, resolveSessionFilePath as N, DEFAULT_SOUL_FILENAME as Nt, isMemoryMultimodalEnabled as O, parseAgentSessionKey as On, DEFAULT_AGENTS_FILENAME as Ot, resolveSessionFilePathOptions as P, DEFAULT_TOOLS_FILENAME as Pt, SafeOpenError as Q, isPathInside as Qt, resolveStorePath as R, loadWorkspaceBootstrapFiles as Rt, splitTextToUtf8ByteLimit as S, isBlockedObjectKey as Sn, resolveAgentWorkspaceDir as St, buildCaseInsensitiveExtensionGlob as T, isAcpSessionKey as Tn, resolveRunModelFallbacksOverride as Tt, getFileExtension as U, resolveWindowsCommandShim as Ut, detectMime as V, runCommandWithTimeout as Vt, imageMimeFromFormat as W, spawnWithFallback as Wt, maxBytesForKind as X, resolvePathViaExistingAncestorSync as Xt, MAX_IMAGE_BYTES as Y, openVerifiedFileSync as Yt, mediaKindFromMime as Z, isNotFoundPathError as Zt, remapChunkLines as _, scopedHeartbeatWakeOptions as _n, resolveAgentConfig as _t, listSessionFilesForAgent as a, DEFAULT_AGENT_ID as an, writeFileFromPathWithinRoot as at, estimateStructuredEmbeddingInputBytes as b, normalizeAccountId as bn, resolveAgentModelFallbacksOverride as bt, buildMultimodalChunkForIndexing as c, buildAgentPeerSessionKey as cn, assertNoPathAliasEscape as ct, ensureDir as d, isValidAgentId as dn, redactToolDetail as dt, normalizeSkillFilter as en, copyFileWithinRoot as et, hashText as f, normalizeAgentId as fn, compileSafeRegex as ft, parseEmbedding as g, sanitizeAgentId as gn, listAgentIds as gt, normalizeExtraMemoryPaths as h, resolveThreadSessionKeys as hn, hasConfiguredModelFallbacks as ht, buildSessionEntry as i, normalizeStringEntriesLower as in, readLocalFileSafely as it, resolveAgentsDirFromSessionStorePath as j, resolveAgentModelPrimaryValue as jn, DEFAULT_HEARTBEAT_FILENAME as jt, normalizeMemoryMultimodalSettings as k, resolveThreadParentSessionKey as kn, DEFAULT_AGENT_WORKSPACE_DIR as kt, chunkMarkdown as l, buildGroupHistoryKey as ln, getDefaultRedactPatterns as lt, listMemoryFiles as m, resolveAgentIdFromSessionKey as mn, runTasksWithConcurrency as mt, isQueryStopWordToken as n, normalizeHyphenSlug as nn, openFileWithinRoot as nt, sessionPathForFile as o, DEFAULT_MAIN_KEY as on, writeFileWithinRoot as ot, isMemoryPath as p, normalizeMainKey as pn, testRegexWithBoundedInput as pt, kindFromMime as q, openBoundaryFile as qt, requireNodeSqlite as r, normalizeStringEntries as rn, readFileWithinRoot as rt, buildFileEntry as s, buildAgentMainSessionKey as sn, PATH_ALIAS_POLICIES as st, extractKeywords as t, normalizeAtHashSlug as tn, createRootScopedReadFile as tt, cosineSimilarity as u, classifySessionKeyShape as un, redactSensitiveText as ut, runWithConcurrency as v, toAgentRequestSessionKey as vn, resolveAgentDir as vt, statRegularFile as w, getSubagentDepth as wn, resolveEffectiveModelFallbacks as wt, estimateUtf8Bytes as x, normalizeOptionalAccountId as xn, resolveAgentSkillsFilter as xt, hasNonTextEmbeddingParts as y, DEFAULT_ACCOUNT_ID as yn, resolveAgentEffectiveModelPrimary as yt, materializeWindowsSpawnProgram as z, resolveOpenClawPackageRoot as zt };
