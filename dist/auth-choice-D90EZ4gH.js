		...
		const server = createServer((req, res) => {
			try {
				...
				res.end([
					...
					"<p>You can close this window and return to Trident.</p></body></html>"
				].join(""));
