import { _g as fetchWithSsrFGuard } from "./auth-profiles-DRjqKE3G.js";
import { h as resolveConfigDir, s as ensureDir, v as resolveUserPath } from "./utils-B88a096J.js";
import { t as runCommandWithTimeout } from "./exec-CdZJtviz.js";
import { i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences } from "./skills-CtzUimzY.js";
import { f as hasBinary } from "./frontmatter-D0K3qXQH.js";
import { p as resolveSkillKey } from "./env-overrides-D7R3RscC.js";
import { V as writeFileFromPathWithinRoot } from "./query-expansion-E78fX0en.js";
import { t as resolveBrewExecutable } from "./brew-BqnB6wF-.js";
import { t as isWithinDir } from "./path-safety-Z97FO1K-.js";
import { f as mergeExtractedTreeIntoDestination, h as isWindowsDrivePath, i as safePathSegmentHashed, m as withStagedArchiveDestination, o as createTarEntryPreflightChecker, p as prepareArchiveDestinationDir, s as extractArchive$1, t as assertCanonicalPathWithinBase } from "./install-safe-path-DZM2JHcC.js";
...
async function collectSkillInstallScanWarnings(entry) {
	...
	try {
		...
		} else if (summary.warn > 0) warnings.push(`Skill "${skillName}" has ${summary.warn} suspicious code pattern(s). Run "trident security audit --deep" for details.`);
	} catch (err) {
		warnings.push(`Skill "${skillName}" code safety scan failed (${String(err)}). Installation continues; run "trident security audit --deep" after install.`);
	}
	return warnings;
}
