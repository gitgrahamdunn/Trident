...
const DEFAULT_CLI_NAME = "trident";
const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "openclaw"]);
const CLI_PREFIX_RE$1 = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(?:openclaw|trident)\b/;
...
const CLI_PREFIX_RE = /^(?:pnpm|npm|bunx|npx)\s+(?:openclaw|trident)\b|^(?:openclaw|trident)\b/;
