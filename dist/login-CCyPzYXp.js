import { I as danger, L as info, V as success, l as defaultRuntime, r as logInfo } from "./logger-mQKrXyAc.js";
import { Ea as formatCliCommand, Hr as resolveWhatsAppAccount, oa as loadConfig, qr as logoutWeb } from "./auth-profiles-DDVivXkv.js";
import { i as waitForWaConnection, n as formatError, t as createWaSocket } from "./session-By0smKqC.js";
...
async function loginWeb(verbose, waitForConnection, runtime = defaultRuntime, accountId) {
	...
	try {
		...
		if (code === DisconnectReason.loggedOut) {
			...
			console.error(danger(`WhatsApp reported the session is logged out. Cleared cached web session; please rerun ${formatCliCommand("trident channels login")} and scan the QR again.`));
