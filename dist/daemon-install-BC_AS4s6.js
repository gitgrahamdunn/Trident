...
import { r as isGatewayDaemonRuntime } from "./daemon-runtime-Cefje0FR.js";
...
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-CdgSjHC6.js";
...
async function installGatewayDaemonNonInteractive(params) {
	...
	if (process.platform === "linux" && !systemdAvailable) {
		runtime.log("Systemd user services are unavailable; skipping service install. Use a direct shell run (`trident gateway run`) or rerun without --install-daemon on this session.");
		return {
			installed: false,
