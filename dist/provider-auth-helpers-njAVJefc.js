...
import { $_ as SYNTHETIC_MODEL_CATALOG, Eg as resolveOpenClawAgentDir, F as resolveModelRefFromString, G_ as buildKimiCodingProvider, H_ as QIANFAN_DEFAULT_MODEL_ID, J_ as TOGETHER_BASE_URL, K_ as buildQianfanProvider, O as normalizeProviderId, Pg as readConfigFileSnapshot, Q_ as SYNTHETIC_DEFAULT_MODEL_REF, Rg as writeConfigFile, Sv as DEFAULT_PROVIDER, T as modelKey, U_ as XIAOMI_DEFAULT_MODEL_ID, W_ as buildKilocodeProvider, X_ as buildTogetherModelDefinition, Y_ as TOGETHER_MODEL_CATALOG, Z_ as SYNTHETIC_BASE_URL, _v as resolveCloudflareAiGatewayBaseUrl, av as HUGGINGFACE_BASE_URL, b as buildModelAliasIndex, ev as buildSyntheticModelDefinition, f as upsertAuthProfile, gv as buildCloudflareAiGatewayModelDefinition, hv as CLOUDFLARE_AI_GATEWAY_DEFAULT_MODEL_REF, iv as buildVeniceModelDefinition, mv as KILOCODE_DEFAULT_MODEL_REF, nv as VENICE_DEFAULT_MODEL_REF, ov as HUGGINGFACE_MODEL_CATALOG, pv as KILOCODE_BASE_URL, q_ as buildXiaomiProvider, rv as VENICE_MODEL_CATALOG, sv as buildHuggingfaceModelDefinition, tv as VENICE_BASE_URL, w as legacyModelKey, yv as normalizeSecretInput } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import { F as toAgentModelListLike, r as listAgentIds } from "./agent-scope-CZIF93u7.js";
import { c as normalizeAgentId } from "./session-key-51LnISpq.js";
import { i as coerceSecretRef, t as DEFAULT_SECRET_PROVIDER_ALIAS } from "./types.secrets-BvNoSfUf.js";
import { a as isWSLEnv } from "./fetch-BmEnSimV.js";
import { t as PROVIDER_ENV_VARS } from "./provider-env-vars-eiXtKwfg.js";
