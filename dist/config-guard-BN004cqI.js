...
import { Q as shouldMigrateStateFromPath } from "./subsystem-BDbeCphF.js";
import { n as isRich, r as theme, t as colorize } from "./theme-H80Q3Qtv.js";
import { Pg as readConfigFileSnapshot } from "./auth-profiles-DRjqKE3G.js";
...
import { t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-DM9Q7QuP.js";
...
async function ensureConfigReady(params) {
	...
	params.runtime.error(`${muted("Run:")} ${commandText(formatCliCommand("trident doctor --fix"))}`);
