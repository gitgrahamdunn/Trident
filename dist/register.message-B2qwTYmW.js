...
import { p as defaultRuntime, v as danger, w as setVerbose } from "./subsystem-D2xHvZZd.js";
import { n as isRich, r as theme } from "./theme-CipOb_We.js";
import "./utils-DwZbjiC4.js";
import { $ as resolveCommandSecretRefsViaGateway, Cm as GATEWAY_CLIENT_MODES, Fo as CHANNEL_TARGET_DESCRIPTION, G as withProgress, Po as CHANNEL_TARGETS_DESCRIPTION, Sf as runGlobalGatewayStopSafely, Wa as CHANNEL_MESSAGE_ACTION_NAMES, Xi as runMessageAction, Y as getChannelsCommandSecretTargetIds, q as formatHelpExamples, u_ as loadConfig, wm as GATEWAY_CLIENT_NAMES, za as formatTargetDisplay } from "./reply-Bm8VrLQh.js";
...
import { a as getChatChannelMeta, l as normalizeChatChannelId } from "./registry-DIAhVWwq.js";
import "./skills-CZKYRFRI.js";
import "./frontmatter-7FVJq8_7.js";
import { t as getChannelPlugin } from "./plugins-Csb211Yn.js";
...
import { t as ensurePluginRegistryLoaded } from "./plugin-registry-9WVGb5U7.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-DCPsyAGn.js";
import { t as createOutboundSendDeps } from "./outbound-send-deps-Df-AlnQf.js";
import { t as shortenText } from "./text-format-Ctfd6y8B.js";
...
${formatHelpExamples([
		["trident message send --target +15555550123 --message \"Hi\"", "Send a text message."],
		["trident message send --target +15555550123 --message \"Hi\" --media photo.jpg", "Send a message with media."],
		["trident message poll --channel discord --target channel:123 --poll-question \"Snack?\" --poll-option Pizza --poll-option Sushi", "Create a Discord poll."],
		["trident message react --channel discord --target 123 --message-id 456 --emoji \"✅\"", "React to a message."]
	])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.trident.ai/cli/message")}`).action(() => {
