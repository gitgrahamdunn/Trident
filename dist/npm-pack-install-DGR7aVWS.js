...
import { g as parseRegistryNpmSpec, h as isPrereleaseResolutionAllowed, m as formatPrereleaseResolutionError } from "./env-overrides-DfvB37sI.js";
import { c as fileExists, d as resolvePackedRootDir, n as resolveSafeInstallDir, s as extractArchive, t as assertCanonicalPathWithinBase, u as resolveArchiveKind } from "./install-safe-path-B1FBV00r.js";
...
async function packNpmSpecToArchive(params) {
	...
	if (res.code !== 0) {
		...
		if (/E404|is not in this registry/i.test(raw)) return {
			ok: false,
			error: `Package not found on npm: ${params.spec}. See https://docs.trident.ai/tools/plugin for installable plugins.`
		};
		return {
			ok: false,
