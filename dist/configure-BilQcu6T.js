...
import { o as isSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-BvNoSfUf.js";
...
import { jt as resolveDefaultSecretProviderAlias, n as listChannelPlugins, t as getChannelPlugin } from "./plugins-C-z6VZlO.js";
...
import { r as setupChannels, t as noteChannelStatus } from "./onboard-channels-CZyPCHEd.js";
...
import { n as isNonFatalSystemdInstallProbeError } from "./systemd---Z1c197.js";
...
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt--YDr2Lo5.js";
import { r as applyAuthChoice } from "./auth-choice-D_GhKlhP.js";
import { t as resolvePreferredProviderForAuthChoice } from "./auth-choice.preferred-provider-2VLbDL8Z.js";
import { a as promptDefaultModel, n as applyModelFallbacksFromSelection, o as promptModelAllowlist, r as applyPrimaryModel, t as applyModelAllowlist } from "./model-picker-BiUIMHaM.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CdgSjHC6.js";
import { a as promptCustomApiConfig } from "./onboard-custom-Ddx3On5K.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-CYc_FQ94.js";
import { t as formatHealthCheckFailure } from "./health-format-n3gqKELa.js";
import { n as promptRemoteGatewayConfig } from "./onboard-remote-f25-fsZp.js";
import { n as setupSkills } from "./onboard-skills-Dsgr1TPu.js";
...
async function promptWebToolsConfig(nextConfig, runtime) {
	...
	const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, applySearchKey, hasKeyInEnv } = await import("./onboard-search-CeLQ2E2N.js");
