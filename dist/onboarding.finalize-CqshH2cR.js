...
import { m as restoreTerminalState } from "./subsystem-D2xHvZZd.js";
import "./theme-CipOb_We.js";
import { h as pathExists, y as resolveUserPath } from "./utils-DwZbjiC4.js";
import { Dt as openUrl, Ft as waitForGatewayReachable, jt as resolveControlUiLinks, kt as probeGatewayReachable, xt as formatControlUiSshHint, yt as detectBrowserOpenSupport } from "./reply-Bm8VrLQh.js";
import { y as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-DvYJ0Ktc.js";
import "./trident-root-3m-COvjr.js";
import "./logger-BZyLeV9r.js";
import "./exec-BQevMHrc.js";
import "./github-copilot-token-Dz62-0BI.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-3Z_Kl5PP.js";
...
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-DRTLcqqw.js";
...
import { t as runTui } from "./tui-Cc1s56fY.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DBh5jHFx.js").then((n) => n.r);
	...
	if (webSearchProvider) {
		const { SEARCH_PROVIDER_OPTIONS, resolveExistingKey, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DRWsG1VN.js");
		...
		const { SEARCH_PROVIDER_OPTIONS, hasExistingKey, hasKeyInEnv } = await import("./onboard-search-DRWsG1VN.js");
