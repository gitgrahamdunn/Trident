...
import { Ch as readGatewayTokenEnv, Km as resolveConfiguredSecretInputWithFallback, Ot as resolveControlUiLinks, Pg as readConfigFileSnapshot, gt as detectBrowserOpenSupport, jg as loadConfig, vt as formatControlUiSshHint, wt as openUrl } from "./auth-profiles-DRjqKE3G.js";
import { t as formatCliCommand } from "./command-format-BTnLVWI8.js";
import "./agent-scope-CZIF93u7.js";
import { g as resolveHomeDir } from "./utils-B88a096J.js";
...
import "./completion-cli-DHtFpvB3.js";
...
import "./update-runner-DwRB0HyE.js";
import "./logging-DRp8gftI.js";
import "./oauth-tls-preflight-BgDtqYZW.js";
import "./doctor-config-flow-DM9Q7QuP.js";
import { a as removeStateAndLinkedPaths, i as removePath, o as removeWorkspaceDirs, r as listAgentSessionDirs, t as buildCleanupPlan } from "./cleanup-utils-BMm3OQGr.js";
...
import "./doctor-completion-LbNI8mVm.js";
...
async function dashboardCommand(runtime = defaultRuntime, options = {}) {
	...
	if (resolvedToken.unresolvedRefReason) {
		...
		runtime.log("Set OPENCLAW_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `trident dashboard`.");
	}
	...
	if (opened) runtime.log("Opened in your browser. Keep that tab to control Trident.");
...
function logBackupRecommendation$1(runtime) {
	runtime.log(`Recommended first: ${formatCliCommand("trident backup create")}`);
}
async function resetCommand(runtime, opts) {
	...
	if (scope === "config+creds+sessions") {
		...
		runtime.log(`Next: ${formatCliCommand("trident onboard --install-daemon")}`);
		return;
	}
	if (scope === "full") {
...
async function removeMacApp(runtime, dryRun) {
	...
	await removePath("/Applications/Trident.app", runtime, {
		dryRun,
		label: "/Applications/Trident.app"
	});
}
